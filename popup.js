...
const KEYS = [
  ...
  'warnRedirectParams', 'warnShorteners', 'monitorLoggerApi', 'detectPhishing', 'blockHighConfidencePhishing', 'behavioralScan', 'removeOverlays', 'autoSkipDownloadAds', 'blockMalwareSites', 'autoUpdateLists',
...
const DEFAULTS = {
  ...
  detectPhishing: true, blockHighConfidencePhishing: false, behavioralScan: true, removeOverlays: true, autoSkipDownloadAds: true, blockMalwareSites: true, autoUpdateLists: true,
