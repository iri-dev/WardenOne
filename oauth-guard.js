...
(function () {
  ...
  try {
    ...
    configLoaded = true;
    try { setTimeout(scanOAuthGrant, 150); } catch (_) {}
  }
  ...
  if (document.readyState === 'loading') document.addEventListener('DOMContentLoaded', scanOAuthGrant, { once: true });
  else setTimeout(scanOAuthGrant, 100);
  try {
    let pending = false;
    ...
    setTimeout(() => { try { scanOAuthGrant(); } catch (_) {} }, 2500);
