...
Everything goes through the **[issue tracker](https://github.com/iri-dev/WebWarden/issues/new/choose)** — there are short guided forms:
...
WebWarden runs entirely on your device: no account, no telemetry. The issue tracker is the way to reach the project.
