/* WebWarden Download Guard review window */
...
function render(review) {
  ...
  if (review.autoBlocked) {
    pauseNote.textContent = 'WebWarden blocked this critical download and removed it from your computer. No further action is needed.';
